    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-8 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-16 bg-gradient-to-r from-soft-brown via-warm-peach to-soft-brown bg-clip-text text-transparent">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="bg-white p-6 rounded-2xl shadow-lg mb-4">
                ...
                <p className="text-gray-600 text-sm">Every decision is guided by compassion.</p>
              </div>
            </div>
            ...
            <div className="text-center">
              <div className="bg-white p-6 rounded-2xl shadow-lg mb-4">
                ...
                <p className="text-gray-600 text-sm">Full health screenings for every companion.</p>
              </div>
            </div>
            ...
            <div className="text-center">
              <div className="bg-white p-6 rounded-2xl shadow-lg mb-4">
                ...
                <p className="text-gray-600 text-sm">We maintain the highest standards.</p>
              </div>
            </div>
            ...
            <div className="text-center">
              <div className="bg-white p-6 rounded-2xl shadow-lg mb-4">
                ...
                <p className="text-gray-600 text-sm">We support families throughout the journey.</p>
              </div>
            </div>
      ...
      {/* More sections stay the same... */}
      
      {/* (Your entire long content stays untouched — only export changed) */}
    </div>
  );
};
