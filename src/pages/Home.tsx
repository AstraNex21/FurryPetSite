...
// Add Playpen Sans font
const link = document.createElement('link');
link.href = 'https://fonts.googleapis.com/css2?family=Playpen+Sans:wght@400;500;600;700;800&display=swap';
link.rel = 'stylesheet';
...
export const Home: React.FC = () => {
  return (
    <div className="min-h-screen bg-white text-gray-900" style={{ fontFamily: 'Playpen Sans, cursive' }}>
      <section className="relative min-h-[40vh] md:min-h-[85vh] overflow-hidden flex items-center justify-center">
        ...
        <div className="absolute inset-0 flex flex-col justify-end items-center text-center text-white px-4 pb-6 md:pb-16 pointer-events-none">
          <h1 className="text-3xl md:text-7xl font-extrabold drop-shadow-xl tracking-tight leading-tight" style={{ fontFamily: 'Playpen Sans, cursive' }}>
            Find your <br />
          ...
          <div className="mt-3 md:mt-6 flex gap-3 md:gap-4 pointer-events-auto">
            <button
              ...
              className="bg-gradient-to-r from-orange-500 to-pink-500 text-white px-6 md:px-8 py-2 md:py-3 rounded-full font-semibold shadow-xl hover:shadow-2xl hover:scale-105 transition text-sm md:text-base"
            ...
            <Link
              to="/contact"
              className="bg-white/70 backdrop-blur-xl px-6 md:px-8 py-2 md:py-3 rounded-full font-semibold text-gray-900 shadow-xl border border-white/80 hover:scale-105 transition text-sm md:text-base"
              style={{ fontFamily: 'Playpen Sans, cursive' }}
            >
              Get in Touch
            </Link>
      ...
      <section className="py-3 md:py-6 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <CloudWrap>
            <h2 className="text-2xl md:text-5xl font-bold text-center" style={{ fontFamily: 'Playpen Sans, cursive' }}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6 mt-4 md:mt-6">
            {breeds.map((b) => (
              ...
              >
                ...
                <p className="text-center mt-2 md:mt-3 font-semibold text-sm md:text-base" style={{ fontFamily: 'Playpen Sans, cursive' }}>{b.name}</p>
              </Link>
            ))}
          </div>
        </div>
